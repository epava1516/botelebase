...
class User(models.Model):
    ...
    phonePrefix = models.IntegerField(null=True)
    phone = models.IntegerField(unique=True)
    tUserID = models.IntegerField(unique=True, null=True, blank=True, default=None)
    ...
    credits = models.IntegerField(null=True, blank=True, default=None)
    creditInUse = models.BooleanField(default=False)
